...
WebUI.click(findTestObject('Indah Mutiah Utami MZ/WEB/Registrasi/Page_Be a Profressional Talent with Coding.ID/button_Buat                                _86b528'))

WebUI.setText(findTestObject('Object Repository/Indah Mutiah Utami MZ/WEB/Registrasi/Page_Buat akun dan dapatkan akses di Coding.ID/input_Nama_name'), 
    'Abdul Budi')
